...
func TestRPCShortFormPrefixed(t *testing.T) {
	...
	err := runAPI(context.Background(), f.deps(), []string{"foo.Bar/Baz"}, stdio)
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
...
func TestRESTLeadingSlashPassthrough(t *testing.T) {
	...
	f := &fakeDeps{}
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(), []string{"/v1/things"}, stdio)
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
...
func TestRPCLeadingSlashPassthrough(t *testing.T) {
	...
	f := &fakeDeps{}
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(), []string{"/rpc/public/foo/Bar"}, stdio)
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
...
func TestMethodGETHasNoBody(t *testing.T) {
	...
	f := &fakeDeps{}
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(), []string{"--method", "GET", "/v1/things"}, stdio)
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
	if f.lastMethod != "GET" {
...
func TestMethodHEADHasNoBody(t *testing.T) {
	...
	f := &fakeDeps{}
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(), []string{"--method", "HEAD", "/v1/things"}, stdio)
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
	if f.lastBody != nil {
...
func TestDataFlagUsedAsBody(t *testing.T) {
	...
	f := &fakeDeps{}
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(),
...
func TestEmptyMethodIsUsageError(t *testing.T) {
	...
	f := &fakeDeps{}
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(), []string{"--method", "", "foo/Bar"}, stdio)
	if !errors.Is(err, cli.ErrUsage) {
		t.Errorf("err = %v, want ErrUsage", err)
	}
}
...
func TestUnknownFlagIsUsageError(t *testing.T) {
	...
	f := &fakeDeps{}
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(), []string{"--nope", "foo/Bar"}, stdio)
	if !errors.Is(err, cli.ErrUsage) {
		t.Errorf("err = %v, want ErrUsage", err)
	}
}
...
func TestTransportErrorWrapped(t *testing.T) {
	...
	stdio, _, _ := testcli.NewIO(nil)
	err := runAPI(context.Background(), f.deps(), []string{"foo/Bar"}, stdio)
...
func TestSuccessPrettyPrint(t *testing.T) {
	...
	if err := runAPI(context.Background(), f.deps(), []string{"foo/Bar"}, stdio); err != nil {
		t.Fatalf("Run: %v", err)
	}
	s := out.String()
...
func TestSuccessRawPassthrough(t *testing.T) {
	...
	stdio, out, _ := testcli.NewIO(nil)
	if err := runAPI(context.Background(), f.deps(), []string{"--raw", "foo/Bar"}, stdio); err != nil {
		t.Fatalf("Run: %v", err)
	}
	if out.String() != `{"a":1}` {
...
func TestSuccessRawStdoutErr(t *testing.T) {
	...
	stdio := testcli.FailingIO()
	err := runAPI(context.Background(), f.deps(), []string{"--raw", "foo/Bar"}, stdio)
	if err == nil || !strings.Contains(err.Error(), "w boom") {
